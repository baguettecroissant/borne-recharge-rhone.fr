...
const LYON_LAT = 45.758;
const LYON_LON = 4.8351;
...
function getMarcheImmobilier(prixM2) {
  ...
  if (prixM2 >= 2500) return 'accessible';
...
console.log(`✅ Enriched ${enriched} communes with SEO data fields.`);
